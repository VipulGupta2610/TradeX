    ...
    <div className="flex h-screen bg-[#FAFAFA] dark:bg-[#020202] text-black dark:text-white transition-colors duration-500 font-sans selection:bg-emerald-500/30 overflow-hidden">
      ...
      <div className="flex-1 relative overflow-y-auto overflow-x-hidden">
        ...
        <main className="relative z-10 w-full max-w-[1600px] mx-auto px-6 md:px-12 py-12">
          ...
          {/* Action Bar (Moved from original Nav) */}
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
              ...
              <motion.div variants={item} className="xl:col-span-4 flex flex-col gap-6">
                ...
                <div className="bg-white/60 dark:bg-[#0A0A0A]/80 backdrop-blur-3xl border border-black/5 dark:border-white/[0.08] rounded-3xl p-4 shadow-xl flex-1 flex flex-col min-h-[400px]">
                  <div className="px-2 pb-4 mb-2 border-b border-black/5 dark:border-white/[0.05] flex justify-between items-center">
                    ...
                    <button className="w-8 h-8 rounded-lg bg-black/5 dark:bg-white/5 flex items-center justify-center hover:bg-black/10 dark:hover:bg-white/10 transition-colors">
                      <svg className="w-4 h-4 text-zinc-500 dark:text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" /></svg>
                    </button>
                  </div>
              ...
              <motion.div variants={item} className="xl:col-span-8 bg-white/60 dark:bg-[#0A0A0A]/80 backdrop-blur-3xl border border-black/5 dark:border-white/[0.08] rounded-[40px] shadow-2xl flex flex-col overflow-hidden relative">
                ...
                <div className="flex-1 p-8 md:p-10 overflow-y-auto relative z-10 bg-black/[0.02]">
                  ...
                  <div className="w-full h-64 bg-white dark:bg-[#050505] rounded-2xl border border-black/5 dark:border-white/5 mb-10 relative overflow-hidden group cursor-pointer flex items-center justify-center">
                    <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.05)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:20px_20px]" />
                    {/* Mock Candlestick SVG */}
                    <svg className="w-32 h-32 opacity-20 text-black dark:text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1"><path strokeLinecap="round" strokeLinejoin="round" d="M7 12l5-5 5 5M7 12l5 5 5-5" /></svg>
                    <div className="absolute inset-0 bg-white/50 dark:bg-black/50 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                ...
                {/* Action Footer */}
                <div className="p-6 border-t border-black/5 dark:border-white/[0.05] bg-black/[0.02] dark:bg-black/[0.05] flex justify-between items-center z-10 relative">
                  <p className="text-xs text-zinc-500">Last edited: Today, 15:42</p>
                  <div className="flex gap-3">
                    <button onClick={() => navigator.clipboard.writeText(`${selectedEntry.market}\n${selectedEntry.notes}`)} className="px-6 py-2.5 rounded-xl border border-black/10 dark:border-white/10 text-sm font-bold hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
                      Share
                    </button>
                    <button onClick={editEntry} className="px-6 py-2.5 rounded-xl bg-black text-white dark:bg-white dark:text-black text-sm font-bold hover:scale-[1.02] active:scale-[0.98] transition-transform shadow-lg">
                      Edit Journal
                    </button>
                  </div>
                </div>
