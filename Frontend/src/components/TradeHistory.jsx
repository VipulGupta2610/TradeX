...
const tradeHistory = [
  { id: 'TRD-9X42A', time: '14:23:05', date: 'Oct 24, 2026', market: 'BTC-PERP', side: 'LONG', action: 'Close', size: '2.5 BTC', execPrice: '$64,230.50', fee: '$32.11', realizedPnL: '+$1,450.00', isWin: true },
  { id: 'TRD-3M11Z', time: '11:05:12', date: 'Oct 24, 2026', market: 'ETH-PERP', side: 'SHORT', action: 'Close', size: '15.0 ETH', execPrice: '$3,450.00', fee: '$10.35', realizedPnL: '+$840.50', isWin: true },
  { id: 'TRD-7B88K', time: '09:15:00', date: 'Oct 24, 2026', market: 'NVDA', side: 'LONG', action: 'Open', size: '50 Shares', execPrice: '$870.00', fee: '$0.00', realizedPnL: '-', isWin: null },
  { id: 'TRD-2P99Q', time: '16:45:33', date: 'Oct 23, 2026', market: 'SOL-PERP', side: 'LONG', action: 'Close', size: '150 SOL', execPrice: '$142.10', fee: '$5.32', realizedPnL: '-$320.00', isWin: false },
  { id: 'TRD-5L22W', time: '10:05:41', date: 'Oct 22, 2026', market: 'AAPL', side: 'SHORT', action: 'Open', size: '200 Shares', execPrice: '$189.40', fee: '$0.00', realizedPnL: '-', isWin: null },
  { id: 'TRD-1R44C', time: '08:22:15', date: 'Oct 22, 2026', market: 'EUR/USD', side: 'SHORT', action: 'Close', size: '100,000 EUR', execPrice: '1.0850', fee: '$2.50', realizedPnL: '+$115.00', isWin: true },
  { id: 'TRD-8K55F', time: '15:10:05', date: 'Oct 21, 2026', market: 'TSLA', side: 'LONG', action: 'Close', size: '100 Shares', execPrice: '$165.00', fee: '$0.00', realizedPnL: '-$450.00', isWin: false },
];
    ...
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#020202] text-black dark:text-white transition-colors duration-500 font-sans selection:bg-emerald-500/30 relative">
      ...
      <nav className="relative z-50 px-8 py-6 flex justify-between items-center border-b border-black/5 dark:border-white/5 backdrop-blur-xl bg-white/40 dark:bg-[#020202]/40">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold tracking-[0.2em] text-sm text-zinc-800 dark:text-zinc-300">TRADE HISTORY</span>
        </div>
