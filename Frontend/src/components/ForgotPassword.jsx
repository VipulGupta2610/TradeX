              ...
              <div className="p-8 md:p-10">
                ...
                <div className="mt-8 text-center space-y-3">
                  <p className="text-xs font-medium text-zinc-500">
                    Didn't receive it? <button onClick={() => setStep(1)} className="font-bold text-white hover:text-cyan-400 transition-colors">Resend Code</button>
                  </p>
                  <button onClick={() => setStep(1)} className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest hover:text-white transition-colors">Use different email</button>
                </div>
              </div>
            </motion.div>
          )}
