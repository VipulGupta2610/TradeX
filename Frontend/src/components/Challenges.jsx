    ...
    <div className="flex h-screen bg-[#FAFAFA] dark:bg-[#020202] text-black dark:text-white transition-colors duration-500 font-sans selection:bg-amber-500/30 overflow-hidden">
      ...
      <div className="flex-1 relative overflow-y-auto overflow-x-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden bg-[#FAFAFA] dark:bg-[#020202] transition-colors duration-500">
          ...
          <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.03)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:100px_100px] [mask-image:radial-gradient(ellipse_100%_100%_at_50%_0%,#000_30%,transparent_80%)]">
            {/* Intersection crosses */}
            <div className="absolute inset-0 bg-[radial-gradient(rgba(0,0,0,0.15)_1px,transparent_1px)] dark:bg-[radial-gradient(rgba(255,255,255,0.2)_1px,transparent_1px)] bg-[size:100px_100px] bg-[position:-0.5px_-0.5px]" />
          </div>
        ...
        <main className="relative z-10 w-full max-w-[1600px] mx-auto px-6 md:px-12 py-12">
          ...
          <motion.div variants={container} initial="hidden" animate="show" className="space-y-12">
            ...
            <motion.div variants={item} className="bg-white/60 dark:bg-[#0A0A0A]/80 backdrop-blur-3xl border border-black/5 dark:border-white/[0.08] rounded-[40px] shadow-2xl relative overflow-hidden group">
              ...
              <div className="p-8 md:p-12 border-b border-black/5 dark:border-white/[0.05] flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 relative z-10">
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <span className="px-2.5 py-1 rounded bg-amber-500/10 text-amber-600 dark:text-amber-500 text-[10px] font-bold uppercase tracking-widest border border-amber-500/20">
                ...
                <div className="flex items-center gap-8">
                  <div className="text-right">
                    ...
                    <p className="text-3xl font-mono font-black text-black dark:text-white">${activeChallenge.currentBalance.toLocaleString()}</p>
                  </div>
                  <div className="h-12 w-px bg-black/10 dark:bg-white/10 hidden sm:block" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-0 divide-y md:divide-y-0 md:divide-x divide-black/5 dark:divide-white/[0.05] relative z-10 bg-black/[0.02]">
                
                {/* Target Profit */}
                <div className="p-8 md:p-12 hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors">
                  <div className="flex justify-between items-end mb-4">
                    <div>
                      <h3 className="text-sm font-bold uppercase tracking-widest text-zinc-500 dark:text-zinc-400 mb-1">Profit Target</h3>
                  ...
                  <div className="w-full h-2 bg-black/10 dark:bg-[#111] rounded-full overflow-hidden border border-black/5 dark:border-white/5">
                    <motion.div 
                ...
                <div className="p-8 md:p-12 hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors">
                  <div className="flex justify-between items-end mb-4">
                    <div>
                      <h3 className="text-sm font-bold uppercase tracking-widest text-zinc-500 dark:text-zinc-400 mb-1">Daily Loss Limit</h3>
                ...
                <div className="p-8 md:p-12 hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors">
                  <div className="flex justify-between items-end mb-4">
                    <div>
                      <h3 className="text-sm font-bold uppercase tracking-widest text-zinc-500 dark:text-zinc-400 mb-1">Max Drawdown</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {availablePrograms.map((program) => (
                  ...
                  >
                    ...
                    {program.popular && (
                      <div className="absolute top-6 right-6 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-600 dark:text-amber-500 text-[10px] font-bold uppercase tracking-widest">
                        Most Popular
                      </div>
                    )}
                    ...
                    <div className="space-y-4 mb-10">
                      <div className="flex justify-between items-center pb-4 border-b border-black/5 dark:border-white/[0.05]">
                        <span className="text-sm text-zinc-500 dark:text-zinc-400 font-medium">Profit Target</span>
                        <span className="text-sm font-bold font-mono text-emerald-500 dark:text-emerald-400">{program.target}</span>
                      </div>
                      <div className="flex justify-between items-center pb-4 border-b border-black/5 dark:border-white/[0.05]">
                        <span className="text-sm text-zinc-500 dark:text-zinc-400 font-medium">Max Daily Loss</span>
                        <span className="text-sm font-bold font-mono text-rose-500 dark:text-rose-400">{program.dailyDrawdown}</span>
                      </div>
                      <div className="flex justify-between items-center pb-4 border-b border-black/5 dark:border-white/[0.05]">
                        <span className="text-sm text-zinc-500 dark:text-zinc-400 font-medium">Max Drawdown</span>
                        <span className="text-sm font-bold font-mono text-rose-500 dark:text-rose-400">{program.maxDrawdown}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-zinc-500 dark:text-zinc-400 font-medium">Minimum Days</span>
                        <span className="text-sm font-bold font-mono text-black dark:text-white">0 Days</span>
                      </div>
                    </div>

                    <button onClick={() => startChallenge(program)} className={`w-full py-4 rounded-xl font-bold text-sm transition-all shadow-lg ${program.popular ? 'bg-amber-500 text-black hover:bg-amber-400 shadow-[0_0_20px_rgba(245,158,11,0.3)]' : 'bg-black text-white dark:bg-white dark:text-black hover:bg-zinc-800 dark:hover:bg-zinc-200'}`}>
