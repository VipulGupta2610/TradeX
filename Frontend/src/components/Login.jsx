...
export default function Login() {
  ...
  const [adminHid, setadminHid] = useState(true)
  ...
  return (
    <div className="themeable-page min-h-screen bg-[#050505] text-white flex overflow-hidden font-sans">
      ...
      <div onDoubleClick={handleAdmin} className="w-full lg:w-[45%] flex flex-col justify-center px-8 sm:px-16 md:px-24 xl:px-32 relative z-10">
          ...
          <motion.form variants={itemVariants} className="space-y-5" onSubmit={handleSubmit(onsubmit)}>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center pl-1 pr-2">
                ...
                <Link to="/ForgotPassword" className="text-xs text-zinc-500 hover:text-white transition-colors">Forgot password?</Link>
              </div>
              <input
                type="password"
                placeholder="••••••••"
