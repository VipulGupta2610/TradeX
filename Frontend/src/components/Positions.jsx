  ...
  return (
    ...
    <div className="flex h-screen bg-[#FAFAFA] dark:bg-[#000000] text-black dark:text-white transition-colors duration-500 font-sans selection:bg-emerald-500/30 overflow-hidden">
      ...
      <div className="flex-1 relative overflow-y-auto overflow-x-hidden">
        ...
        {/* --- MAIN CONTENT AREA --- */}
        {/* Removed internal scrolling logic, letting the parent wrapper handle it */}
        <main className="relative z-10 w-full max-w-[1600px] mx-auto px-6 md:px-8 py-10">
          <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
            ...
            <motion.div variants={item} className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-4">
              ...
              <div className="flex gap-2">
                ...
                <Link to={user?._id ? `/Portfolio/${user._id}` : '/Login'} className="px-6 py-2.5 bg-black dark:bg-white text-white dark:text-black rounded-xl text-sm font-bold hover:scale-[1.02] active:scale-[0.98] transition-transform shadow-[0_0_20px_rgba(0,0,0,0.1)] dark:shadow-[0_0_20px_rgba(255,255,255,0.1)]">
                  Manage Margin
                </Link>
              </div>
            </motion.div>
